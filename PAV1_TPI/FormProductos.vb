Public Class FormProductos
    ...
    Private Sub FormProductos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.cargar_productos()
        Soporte.cargar_combo(cbo_rubro, Soporte.leerBD("SELECT * FROM rubros"), "id_rubro", "nombre")
        Soporte.cargar_combo(cbo_rubroBUSCAR, Soporte.leerBD("SELECT * FROM rubros"), "id_rubro", "nombre")
        Soporte.cargar_combo(cbo_fabrica, Soporte.leerBD("SELECT * FROM fabricas"), "id_fabrica", "nombre")
