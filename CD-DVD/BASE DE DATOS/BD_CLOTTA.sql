...
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (0,'Campera verde', 1,250, 750,10,1,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (1,'Jean nevado celeste', 1,240, 645, 2,2,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (2,'Camisa Hindú', 1, 200,320, 2,3,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (3,'Sweater Hilo Estampado', 1,300, 480,3,9,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (4,'Buzo con Mickey', 1,230,650,12,5,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (5,'Musculosa lisa blanca', 0,300, 350,3,10,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (6,'Musculosa lisa negra', 0,220, 275,	3,4,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (7,'Campera vaquera celeste', 1,300, 545,3,5,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (8,'Buzo gris mangas 3/4',	1, 500,635,	12,7,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (9,'Sweater grueso azul marino',1,10,12,3,8,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (10,'Chalina verde con detalles dorados',2,100,150,9,10,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (11,'Remera mangas largas c/inscripción', 0,100, 340,3,3,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (12,'Chupin negro',2,300,650,3,4,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (13,'Gorro verde militar', 2,60,150,14,7,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (14,'Mochila portanotebook cuero bordó',1,300,870,3,6,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (15,'Cartera color beige', 1,400,450,3,2,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (16,'Saquito de lana gris', 1,300,575,19,1,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (17,'Vestido verde estampado', 1,400,700,20,9,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (18,'Soquetes rallados rosa', 10,10, 50,3,8,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (19,'Campera de cuero negro', 2,300, 950,3,5,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (20,'Pulseras de plata',3,10, 120,14,8,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (21,'Aros c/ detalle violeta', 3,10, 70,14,2,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (22,'Buzo blanco c/inscripción',1,100, 480,12,3,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (23,'Cartera de mano estampada',1,130, 350,3,6,0)
INSERT INTO productos(id_producto,descripcion,stock,precio_compra,precio_venta,id_rubro,id_fabrica,dado_de_baja) VALUES (24,'Remera violeta',0,200, 275,3,10,0)
