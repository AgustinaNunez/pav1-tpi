Public Class FormClientes
    ...
    Private Sub FormClientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Soporte.cargar_combo(cmb_tipo_documento_cliente_carga, Soporte.consultarBD("SELECT * FROM tipo_documento"), "id_tipo_documento", "nombre_tipo_documento")
        Soporte.cargar_combo(cmb_tipo_documento_cliente_busqueda, Soporte.consultarBD("SELECT * FROM tipo_documento"), "id_tipo_documento", "nombre_tipo_documento")
    End Sub
